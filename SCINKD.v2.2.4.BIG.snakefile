...
#snakemake --use-conda --rerun-incomplete --nolock --cores 24 -s SCINKD/SCINKD.v2.2.4.BIG.snakefile
...
rule meryl_hap1_count:
	...
	shell:
		"""
		meryl count k=28 memory={resources.mem_gb} threads={threads} output {output} {input.split}/*.fa
		"""
